...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            ...
            <p class="text-gray-600 mt-2">Daftar proyek yang Anda ikuti bersama anggota tim Anda.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach($projects as $project)
                    <div class="bg-white rounded-lg shadow-md p-4">
                        ...
                        <a href="{{ route('developer.my-team.show', $project->project_id) }}" class="text-blue-600 hover:underline text-sm font-semibold">Lihat Detail →</a>
                    </div>
                @endforeach
            </div>
        @endif
